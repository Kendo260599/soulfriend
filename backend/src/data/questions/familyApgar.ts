...
const familyAPGARQuestions: FamilyAPGARQuestion[] = [
  {
    ...
    englishText: 'I am satisfied with the help I receive from my family when something is troubling me.',
    culturalNote: 'Vietnamese families traditionally provide strong support during crises - consider extended family involvement'
  },
  {
    id: 'apgar_2_partnership',
    domain: 'partnership',
    vietnameseText: 'Tôi hài lòng với cách gia đình tôi thảo luận và chia sẻ vấn đề với nhau.',
    englishText: 'I am satisfied with the way my family talks over things with me and shares problems with me.',
    culturalNote: 'Hierarchical communication patterns may affect open discussion - respect for elders is important'
  },
  {
    id: 'apgar_3_growth',
    domain: 'growth',
    vietnameseText: 'Tôi hài lòng với việc gia đình chấp nhận và ủng hộ mong muốn tham gia hoạt động mới của tôi.',
    englishText: 'I am satisfied that my family accepts and supports my wishes to take on new activities or directions.',
    culturalNote: 'Balance between individual growth and family expectations is crucial in Vietnamese culture'
  },
  {
    id: 'apgar_4_affection',
    domain: 'affection',
    vietnameseText: 'Tôi hài lòng với cách gia đình thể hiện tình cảm và phản hồi với cảm xúc của tôi.',
    englishText: 'I am satisfied with the way my family expresses affection and responds to my emotions.',
    culturalNote: 'Emotional expression may be more subtle in Vietnamese families - actions often speak louder than words'
  },
  {
    id: 'apgar_5_resolve',
    domain: 'resolve',
    ...
    culturalNote: 'Quality time together is highly valued in Vietnamese families, including extended family activities'
  }
];
...
function generateFamilyAPGARRecommendations(totalScore: number, domainScores: any): string[] {
  ...
  if (totalScore >= 8) {
    ...
    recommendations.push('Gia đình có một số khó khăn về chức năng. Cần cải thiện giao tiếp và hỗ trợ.');
...
function generateCulturalConsiderations(domainScores: any): string[] {
  ...
  considerations.push('Xem xét vai trò của gia đình mở rộng (ông bà, cô dì chú bác) trong hỗ trợ gia đình.');
