...
export function scoreMRS(answers: Record<number, number>) {
  ...
  if (totalScore <= 4) {
    severity = 'none';
    interpretation =
      'Không có hoặc có rất ít triệu chứng mãn kinh. Bạn đang trải qua giai đoạn chuyển tiếp một cách tự nhiên.';
    recommendations = [
    ...
    severity = 'mild';
    interpretation =
      'Triệu chứng mãn kinh nhẹ. Các triệu chứng có thể gây khó chịu nhưng không ảnh hưởng nhiều đến chất lượng cuộc sống.';
    recommendations = [
    ...
    severity = 'moderate';
    interpretation =
      'Triệu chứng mãn kinh trung bình. Các triệu chứng có thể ảnh hưởng đến công việc, giấc ngủ và các mối quan hệ.';
    recommendations = [
    ...
    severity = 'severe';
    interpretation =
      'Triệu chứng mãn kinh nghiêm trọng. Các triệu chứng ảnh hưởng đáng kể đến chất lượng cuộc sống và cần được điều trị tích cực.';
    recommendations = [
