...
const parentalStressQuestions: ParentalStressQuestion[] = [
  ...
  },
  {
    ...
    isPositive: true,
    culturalNote:
      'Children are traditionally seen as bringing honor and continuation to Vietnamese families',
  },
  {
    id: 'pss_3_enjoy',
    domain: 'parental_rewards',
  ...
  },
  {
    ...
    isPositive: false,
    culturalNote:
      "Financial stress is particularly acute for Vietnamese families investing heavily in children's education",
  },
  {
    id: 'pss_9_worry',
    domain: 'parental_stressors',
    ...
    isPositive: false,
    culturalNote:
      "Vietnamese parents often feel intense pressure for children's academic and career success",
  },
  ...
  },
  {
    ...
    isPositive: false,
    culturalNote:
      'This may be particularly sensitive in Vietnamese culture where parenthood is highly valued',
  },
  ...
  // Additional Parental Stressors
  {
    ...
    isPositive: false,
    culturalNote:
      'Social isolation may be compounded by expectations for mothers to be primary caregivers',
  },
  {
    id: 'pss_17_support',
    domain: 'parental_rewards',
  ...
  },
  {
    ...
    isPositive: false,
    culturalNote:
      "Vietnamese parents face intense social expectations about children's academic performance and behavior",
  },
];
...
function generateParentalStressCulturalConsiderations(domainScores: any): string[] {
  ...
  considerations.push(
    'Trong văn hóa Việt Nam, làm cha/mẹ được xem là vai trò thiêng liêng và trách nhiệm lớn.'
  );
  considerations.push(
    'Kỳ vọng xã hội về thành công học tập của con có thể tạo áp lực lớn cho cha/mẹ.'
  );
  ...
  if (domainScores.lack_of_control > 20) {
    considerations.push(
      'Vai trò truyền thống của người mẹ như người chăm sóc chính có thể gây căng thẳng.'
    );
  ...
  considerations.push(
    'Cân bằng giữa các giá trị truyền thống và phương pháp nuôi dạy con hiện đại.'
  );
...
const parentalStressTest = {
  testInfo: {
    ...
    description:
      'Đánh giá mức độ căng thẳng trong vai trò làm cha/mẹ qua 4 lĩnh vực: Phần thưởng, Căng thẳng, Mất kiểm soát, Hài lòng',
    version: '2.0',
    ...
    culturalNote:
      'Đặc biệt phù hợp cho các bà mẹ Việt Nam đang đối mặt với áp lực xã hội về việc nuôi dạy con',
  },
