...
export function scorePMS(answers: Record<number, number>) {
  ...
  if (totalScore <= 15) {
    severity = 'minimal';
    interpretation = 'Triệu chứng tiền kinh nguyệt ở mức tối thiểu. Bạn có thể trải qua một số khó chịu nhẹ trước kỳ kinh nhưng không ảnh hưởng nhiều đến cuộc sống hàng ngày.';
    recommendations = [
    ...
    severity = 'mild';
    interpretation = 'Triệu chứng tiền kinh nguyệt nhẹ. Bạn có thể cảm thấy một số khó chịu trước kỳ kinh nhưng vẫn có thể hoạt động bình thường.';
    recommendations = [
    ...
    severity = 'moderate';
    interpretation = 'Triệu chứng tiền kinh nguyệt trung bình. Các triệu chứng có thể ảnh hưởng đến công việc, học tập và các mối quan hệ của bạn.';
    recommendations = [
    ...
    severity = 'severe';
    interpretation = 'Triệu chứng tiền kinh nguyệt nghiêm trọng (có thể là PMDD). Các triệu chứng ảnh hưởng đáng kể đến chất lượng cuộc sống và cần được điều trị chuyên khoa.';
    recommendations = [
