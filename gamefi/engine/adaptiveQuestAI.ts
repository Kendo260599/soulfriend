...
const CHAIN_TEMPLATES: Record<string, {
  ...
  loneliness: {
    ...
    steps: [
      { title: 'Viết Cảm Xúc Cô Đơn', description: 'Viết ra cảm giác cô đơn của bạn.', xpReward: 5, growthImpact: { emotionalAwareness: 2 } },
      { title: 'Nhớ Về Một Người Bạn', description: 'Viết về một người bạn quan trọng trong đời.', xpReward: 8, growthImpact: { relationshipQuality: 3 } },
      { title: 'Gửi Lời Động Viên', description: 'Gửi một lời động viên cho ai đó trong cộng đồng.', xpReward: 12, growthImpact: { relationshipQuality: 5, emotionalAwareness: 2 } },
    ],
  },
  self_worth: {
    ...
    steps: [
      { title: 'Nhận Diện Suy Nghĩ', description: 'Viết ra suy nghĩ tiêu cực về bản thân.', xpReward: 5, growthImpact: { emotionalAwareness: 2 } },
      { title: 'Tìm Bằng Chứng Ngược', description: 'Tìm 3 bằng chứng phản bác suy nghĩ tiêu cực đó.', xpReward: 10, growthImpact: { cognitiveFlexibility: 4 } },
      { title: 'Viết Thư Cho Bản Thân', description: 'Viết một bức thư động viên cho chính mình.', xpReward: 12, growthImpact: { cognitiveFlexibility: 3, psychologicalSafety: 3 } },
    ],
  },
  anxiety: {
    ...
    steps: [
      { title: 'Ghi Nhận Lo Lắng', description: 'Viết ra 3 điều đang khiến bạn lo lắng.', xpReward: 5, growthImpact: { emotionalAwareness: 3 } },
      { title: 'Hơi Thở An Toàn', description: 'Thực hành 3 phút thở sâu và ghi lại cảm nhận.', xpReward: 8, growthImpact: { psychologicalSafety: 4 } },
      { title: 'Ba Điều Ổn Hôm Nay', description: 'Viết 3 điều nhỏ khiến bạn cảm thấy ổn hôm nay.', xpReward: 10, growthImpact: { psychologicalSafety: 3, meaning: 2 } },
    ],
  },
  meaning: {
    ...
    steps: [
      { title: 'Điều Quan Trọng Nhất', description: 'Viết ra 3 điều quan trọng nhất với bạn lúc này.', xpReward: 5, growthImpact: { meaning: 3 } },
      { title: 'Hình Dung Tương Lai', description: 'Mô tả cuộc sống lý tưởng của bạn sau 1 năm.', xpReward: 10, growthImpact: { meaning: 4, cognitiveFlexibility: 2 } },
      { title: 'Một Bước Nhỏ', description: 'Chọn một hành động nhỏ hôm nay hướng tới tương lai đó.', xpReward: 12, growthImpact: { meaning: 3, psychologicalSafety: 2 } },
    ],
  },
  resilience: {
    ...
    steps: [
      { title: 'Nhìn Lại Khó Khăn', description: 'Viết về một khó khăn bạn đã trải qua.', xpReward: 5, growthImpact: { emotionalAwareness: 3 } },
      { title: 'Bài Học Từ Thử Thách', description: 'Bạn đã học được gì từ trải nghiệm đó?', xpReward: 10, growthImpact: { cognitiveFlexibility: 3, meaning: 2 } },
      { title: 'Chia Sẻ Sức Mạnh', description: 'Chia sẻ bài học này với cộng đồng để giúp người khác.', xpReward: 12, growthImpact: { relationshipQuality: 3, emotionalAwareness: 2 } },
    ],
  },
};
