/**
 * SIMPLE TEST SERVER
 * Test the backend server with minimal configuration
 */
...
process.env.NODE_ENV = 'development'; // Use development to bypass strict validation
...
process.env.GEMINI_API_KEY = '***REDACTED_GEMINI_KEY***';
process.env.HEALTH_CHECK_INTERVAL = '30000';
process.env.BACKUP_RETENTION_DAYS = '30';
process.env.BACKUP_PATH = '/backups';

console.log('✅ Environment variables set (development mode)');
